...
export type __SubscriptionContainer = {
  ...
  subscribeToNewUCs: SubscribeToNewUCsSubscription;
  subscribeToNewUsers: SubscribeToNewUsersSubscription;
};
...
export class APIService {
  ...
  SubscribeToNewUCsListener(
    ...
    SubscriptionResponse<Pick<__SubscriptionContainer, "subscribeToNewUCs">>
  > {
  ...
  SubscribeToNewUsersListener: Observable<
    SubscriptionResponse<Pick<__SubscriptionContainer, "subscribeToNewUsers">>
  > = API.graphql(
    graphqlOperation(
